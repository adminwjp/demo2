...
use app\model\Syjfankui;
use app\model\Syjlike;
use app\model\Syjthread;
use app\model\Syjuser;
use app\model\Syjpinglun;
use app\model\Syjuid;
...
class Test extends BaseController
{
    ...
    public function initialize()
    {
        ...
        $this->domain=$this->request->scheme().'://'.$this->request->host().'/';
...
//         }
    ...
    public function getlist()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if(preg_match("/https:\/\/api\.xf512\.com\//ism",$value['img'])){
                $data[$key]['img']=preg_replace("/https:\/\/api\.xf512\.com\//ism",$this->domain,$value['img']);
            }
        }
        $token = '';
        // 设置了res且未出错
